...
<div class="topnav" onload="makeitactiveonload()">
        ...
        <a  class="active"  onclick="disableothersonclick('overviewid')">Overview</p></a>


        <a  onclick="disableothersonclick('agendaid')" >Agenda</p></a>
